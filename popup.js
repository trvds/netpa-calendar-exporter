...
console.log('Popup script is executing.');
            ...
            return new Promise((resolve, reject) => {
                ...
                chrome.tabs.sendMessage(currentTabId, { action: 'get_next_url' }, function (response) {
                    ...
                    if (nextUrl) {
                        ...
                        console.log("No more weeks to scrape!");
